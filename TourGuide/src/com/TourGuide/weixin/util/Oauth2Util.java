...
public class Oauth2Util {
	...
	// "11d33e83aab183855f77a779a42d894d";

	// 公众账号的唯一标识
	public static final String appid = "wx171cb025a40b648f";
	// 公众账号的密钥
	public static final String appSecret = "8aa473942124901e6819bf30789d0e7e";

	/**
	 * 获取网页授权凭证。根据code获取access_token
	 * 
	 * @param code
	 * @return json数据包：access_token,网页授权接口调用凭证 expires_in，access_token的有效时长
	 *         refresh_token,用于刷新access_token openid,用户唯一标识 scope,用户授权的作用域
	 */
	public static WeixinOauth2Token getOauth2AccessToken(String code) {
		...
		// 获取网页授权凭证
		JSONObject jsonObject = TokenUtil.getTokenJsonObject(requestUrl, "GET",
				null);
	 ...
	 * 
	 * @param refreshToken
	 * @return access_token的有效时长为7200秒，如果超时，
	 */
	public static WeixinOauth2Token refreshOauth2AccessToken(String refreshToken) {
		...
		if (null != jsonObject) {
			try {
				oauth2Token = new WeixinOauth2Token();
				oauth2Token.setAccessToken(jsonObject.get("access_token")
						.toString());
				oauth2Token.setExpiresIn(Integer.parseInt(jsonObject.get(
						"expires_in").toString()));
				oauth2Token.setRefreshToken(jsonObject.get("refresh_token")
						.toString());
				...
				System.out.printf("刷新网页授权失败 errcode:{} errmsg:{}", errorCode,
						errorMsg);
			}
		}
		return oauth2Token;
	 ...
	 * 
	 * @param source
	 *            http://1f656026j8.imwork.net/TourGuide/oauthServlet
	 * @return
	 */
	 ...
	 * 构造网页授权链接
	 * 
	 * @return 引导用户访问此链接，将会获得code。若code为“authdeny”，表示用户拒绝授权。
	 */
	public static String getOauth2Url() {
		...
		// String redirectUrI =
		// urlEncodeUTF8("http://1f656026j8.imwork.net/TourGuide/oauthServlet");

		// String redirectUrI =
		// urlEncodeUTF8("http://cps.xaut.edu.cn/TourGuide/oauthServlet");

		String redirectUrI = urlEncodeUTF8("http://cps.xaut.edu.cn/TourGuide/oauthServlet");

		// String redirectUrI =
		// urlEncodeUTF8("http://168r7882j9.imwork.net/TourGuide/oauthServlet");
