...
//	n.scenicName;
	...
	var item = "<div class='kepinorder' onclick='putmnn(" + n.guideFee + "," + ynum + "," + s + ")'><div class='orderlisttitle'>" +
...
function fillkepinorder(data){
	...
	$.each(data, function(i,item1){
		...
		var item = "<div class='kepinorder' onclick='putmnn(" + item1.guideFee + "," + item1.num + "," + item1.orderID + ")'><div class='orderlisttitle'>" +
...
//		else{
		...
		window.location.href = "ConsistOrderList.html?OrderID="+kporderid+"&visitname="+name+"&visitphone="+phone+"&pdnum="+num;
...
//	if(today1 == $("input[name='rdofq']:checked").val()){
//		alert(1);
//	}
////	alert(today1);
////	alert($("input[name='rdofq']:checked").val());
//}
